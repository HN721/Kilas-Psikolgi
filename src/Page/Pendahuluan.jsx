  ...
  return (
    <>
      <div className="">
        ...
        <div className="h-screen flex row lg:items-center">
          <div className="px-10 lg:mx-16 mt-10">
            <h1 className="font-bold font-mono text-2xl lg:text-5xl">
              Pengenalan Singkat Psikologi
            </h1>
            <p className="font-semibold w-full text-2xl lg:w-2/5">{fullText}</p>
            <div className="flex py-10 lg:mt-12 gap-2">
              <Link to={"/"}>
                <button className="bg-black text-primary lg:w-56 w-auto p-3 rounded-2xl">
                  Back
                </button>
              </Link>
              <Link to={"/tokoh"}>
                <button className="bg-secondary hover:bg-button lg:w-56 w-auto p-3 rounded-2xl text-slate">
                  Selanjutnya
                </button>
              </Link>
            </div>
